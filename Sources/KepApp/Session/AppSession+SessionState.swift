...
extension AppSession {
    ...
    private static let openTabsKey = "kep.session.openTabs"
    private static let activeTabKey = "kep.session.activeTab"
    private static let viewStatesKey = "kep.session.canvasViewStates"
