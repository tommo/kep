...
public struct Snippet: Identifiable, Codable, Hashable, Sendable {
    ...
    /// Whether the snippet is bundled with Kep (read-only) or user-defined.
...
/// `~/Library/Application Support/Kep/snippets.json` (configurable for
