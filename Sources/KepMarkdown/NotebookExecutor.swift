...
/// (which owns KepScript) so KepMarkdown stays free of a scripting dep.
...
/// Injected by the app (which owns the agent loop + KepScript).
...
public extension Notification.Name {
    ...
    static let focusNotebookCommand = Notification.Name("kep.focusNotebookCommand")
}
