...
public extension Notification.Name {
    ...
    static let mindmapSettingsChanged = Notification.Name("kep.mindmapSettingsChanged")
}
...
public final class MindMapView: NSView {
    ...
    public override func draw(_ dirtyRect: NSRect) {
        ...
        // kep focus-styling rule — see FocusStyle).
...
// `Topic.move(child:to:)` now lives in KepModel (public), reused here.
