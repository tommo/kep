...
public enum CodeArea {
    ...
    /// Sets the common defaults: 13pt monospaced font, undo, find bar,
    /// resizable height, width tracking. Returns both views so the caller
    /// can install them and add per-editor configuration.
