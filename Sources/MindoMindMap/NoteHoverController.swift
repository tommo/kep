...
/// markers. The popover is a FIXED size (content scrolls if longer): measuring
/// after load made it visibly grow/shrink, which was jarring.
final class NoteHoverController: NSViewController {
    ...
    override func loadView() {
        ...
        view = web
        preferredContentSize = NSSize(width: Self.width, height: Self.height)
    }
}
