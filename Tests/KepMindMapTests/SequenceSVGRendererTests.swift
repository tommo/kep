...
final class SequenceSVGRendererTests: XCTestCase {
    ...
    func testActorBoxesAreClickableSourceLinks() {
        let s = svg("@startuml\nAlice -> Bob: hi\n@enduml")
        // Each actor head/foot is wrapped in an <a href="kep-src:Name">.
        XCTAssertTrue(s.contains("<a href=\"kep-src:Alice\""), s)
        XCTAssertTrue(s.contains("<a href=\"kep-src:Bob\""))
        XCTAssertTrue(s.contains("xlink:href=\"kep-src:Alice\""))
    }
