...
/// injected read/write closures. (The real cell logic lives in KepCSV and is
/// covered by CSVSheetTests; here we verify the agent wiring with stubs.)
final class AgentCSVToolsTests: XCTestCase {

    private func tools(_ effects: AgentToolEffects) -> KepAgentTools {
        KepAgentTools(map: MindMap(root: Topic(text: "Root")),
