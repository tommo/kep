...
final class AgentToolsTopicExtrasTests: XCTestCase {
    ...
    private func tools(_ map: MindMap, effects: AgentToolEffects = AgentToolEffects()) -> KepAgentTools {
        KepAgentTools(map: map, effects: effects)
    }
