...
final class AgentToolsMindmapEditTests: XCTestCase {
    ...
    ///       A2
    ///     B
    private func makeTools() -> (MindoAgentTools, MindMap, AgentToolEffects) {
        ...
        let tools = MindoAgentTools(map: map, effects: effects)
    ...
    private func call(_ tools: MindoAgentTools, _ name: String, _ args: [String: Any]) -> String {
